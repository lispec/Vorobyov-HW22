            ...
            foreach ($photos as $photo): ?>
                ...
                <div class="photo">
                    ...
                    <div class="form-group">
                        <?php
                        // шаринга ссылок
                        \gallery\components\SocialLinks::shareLinks("http://localhost/user/$username/", $photo['description'], 'Extended page description', "http://localhost/user/$username/photo/".$photo['id'], '@twitterUser'); ?>
                    </div>
